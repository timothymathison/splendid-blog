const notFoundMsg = 'Perhaps you\'ve taken a wrong turn, route or resource not found!';
...
const notFound = (res, msg) => {
    console.error('Route or resource not found');
    res.status(404).send({
        message: msg || notFoundMsg
    });
};
...
const unSupportedMedia = (res, msg) => {
    ...
    res.status(415).send({
        message: msg || unSupportedMediaMsg
    });
};
